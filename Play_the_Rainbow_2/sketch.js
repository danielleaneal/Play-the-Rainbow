 ...
 * @description Play a song, play the rainbow. Explore how
 ...
 create longer, more zany songs that have visuals along with them.   I also made the colors flicker for as long as the mouse is       pressedso that the visuals could be as much a part of the "song" as the musical tones are. I also incorporated randomness in the
 automatic playing of the project as well to allow the program 
 itself to create a wild, synesthetic experience for your viewing
 pleasure. 
 This Project was created using p5js example "Hello_p5: song" as a
 starting off point. 
